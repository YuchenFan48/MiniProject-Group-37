...
//
<form method="post" action="./ModifyCar">
<div class="container">
    <table>
        <tr>
            <th>Car name</th><td><input type="text" name="newCarName" ></td>

        </tr>
        <tr>
            <th>Color</th><td><input type="text" name="newCarColor" ></td>
        </tr>
        <tr>
            <th>Number of Axes</th><td><input type="text" name="newCarFreedom"></td>
        </tr>
        <tr>
            <th>Number of Wheels</th><td><input type="text" name="newCarWheelNum" ></td>
        </tr>
        <tr>
            <th>Power</th><td><input type="text" name="newCarPower" ></td>
        </tr>
        <tr>
            <th width="260px" height="40px" align="center"><input type="SUBMIT" name="submit1" value="Submit">
            </th>
        </tr>
    </table>
</div>
